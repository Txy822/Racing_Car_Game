package GameModes.Multiplayer.UI.Toast;
...
A modified version of alcoolis's answer on stackoverflow.com

 */

public final class Toast {

  public static void makeText(Stage ownerStage, String toastMsg, int toastDelay, int fadeInDelay,
      int fadeOutDelay) {
